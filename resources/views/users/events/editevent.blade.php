    ...
    <section class="border rounded border-solid border-gray-200 bg-gray-100 shadow-lg p-4 sm:w-3/5 mx-auto ">
        ...
        <form id="updateDataForm" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-col mb-4">
                ...
                <input type="text" name="judul" id="judul" class="rounded border-2 border-gray-300 focus:bg-gray-200 active:border-blue-400 active:border-solid active:border-2" value="{{ $event->judul }}">
            </div>

            <div id="event" class="flex flex-col w-full">
            ...
            <button id="submitForm" type="buton" onclick="disableButton()" class="p-2 bg-blue-500 w-full rounded text-white transision delay-500 duration-300">Update Event</button>
