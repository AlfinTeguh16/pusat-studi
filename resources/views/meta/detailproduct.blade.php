...
<div class="max-w-4xl flex flex-col justify-center mx-auto">
    ...
    <div class="p-4 ">
        <a href="{{ url('/products')}}" class="p-2 bg-slate-300 hover:bg-slate-700 rounded-md font-medium hover:text-white delay-150"><i class="ph-bold ph-caret-left"></i>  Kembali</a>
    </div>
